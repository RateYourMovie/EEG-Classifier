...
result_array_three=[]
result_array_one=[]
three_minute_data=np.load('data/three_file_path/plv_three_minute_data_2sec.npy')
one_minute_data=np.load('data/one_file_path/plv_one_minute_data_2sec.npy')
...
np.save('data/training_data_plv_2sec.npy',training_data)
np.save('data/testing_data_plv_2sec.npy',testing_data)
