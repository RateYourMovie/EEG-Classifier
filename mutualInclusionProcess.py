...
np.save('data/three_file_path/MI_three_minute_data.npy',processed_three_epochs_array)
np.save('data/one_file_path/MI_one_minute_data.npy',processed_one_epochs_array)